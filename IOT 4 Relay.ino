...
const char DEVICE_LOGIN_NAME[]  = "b7635781-39ee-4689-b187-2d742147e4ff"; //Enter DEVICE ID

const char SSID[]               = "WIFI@RUMAHSOLUSI";    //Enter WiFi SSID (name)
const char PASS[]               = "@Rusol818";    //Enter WiFi password
const char DEVICE_KEY[]         = "Q0L?zT@gvLWopNXjydMZaPkaK";    //Enter Secret device password (Secret Key)
